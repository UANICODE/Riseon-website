...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0A1628] text-white/90 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
              ...
              Rise<span className="text-[#4FB0D9]">⏻</span>N
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center gap-3 text-white/60 hover:text-white transition group">
                ...
                <a href="https://riseon.pt" target="_blank" rel="noopener noreferrer" className="hover:text-[#4FB0D9] transition">
                  riseon.pt
                </a>
              </li>
            </ul>
