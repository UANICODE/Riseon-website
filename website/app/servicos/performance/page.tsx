...
import { ArrowLeft, BarChart3, Database, Gauge, FileText } from 'lucide-react';
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-6">
          <div className="bg-white rounded-xl p-6 shadow-sm border border-riseon-borderLight">
            ...
            <p className="text-riseon-textSecondary text-sm mt-2">
              Informação agregada de múltiplas fontes (vendas, marketing, RH, operações) numa única plataforma visual.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-riseon-borderLight">
            ...
            <p className="text-riseon-textSecondary text-sm mt-2">
              Definição e monitorização dos indicadores estratégicos mais relevantes para o seu negócio.
            </p>
          </div>

          <div className="bg-white rounded-xl p-6 shadow-sm border border-riseon-borderLight">
            <BarChart3 className="text-gold-dark mb-3" size={28} />
