          ...
          <div className="p-8 md:p-10 space-y-8">
            ...
            <div>
              <h2 className="font-heading text-xl font-bold text-riseon-navy flex items-center gap-3">
                <Database size={18} className="text-riseon-blue" />
            ...
            <div>
              <h2 className="font-heading text-xl font-bold text-riseon-navy flex items-center gap-3">
                <Eye size={18} className="text-riseon-blue" />
            ...
            <div>
              <h2 className="font-heading text-xl font-bold text-riseon-navy flex items-center gap-3">
                <FileText size={18} className="text-riseon-blue" />
                Os seus direitos
              </h2>
            ...
            <div className="bg-riseon-surface rounded-xl p-6 border border-riseon-borderLight">
              <h3 className="font-heading text-lg font-bold text-riseon-navy">Contacto para questões de privacidade</h3>
              ...
              <div className="mt-3 flex flex-col sm:flex-row gap-3 text-sm">
                <a href="mailto:privacidade@riseon.pt" className="text-riseon-blue hover:text-riseon-navy transition font-medium">
            ...
            <p className="text-xs text-riseon-textMuted text-center">
