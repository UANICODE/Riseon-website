        ...
        <div className="bg-white rounded-2xl shadow-lg border border-riseon-borderLight overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-riseon-navy to-riseon-blue p-8 md:p-12">
            <div className="flex flex-col md:flex-row items-center gap-8">
              {/* ===== FOTO COM IMAGEM ===== */}
              <div className="relative w-32 h-32 rounded-full overflow-hidden border-4 border-white/30 shadow-xl flex-shrink-0">
                <Image
                  src={member.photo}
                  alt={member.name}
                  fill
          ...
          <div className="p-8 md:p-12 space-y-8">
            ...
            <div className="pt-6 border-t border-riseon-borderLight">
              <Link
                href="/contactos"
                className="inline-flex items-center gap-2 bg-riseon-navy text-white px-6 py-3 rounded-lg font-medium hover:bg-riseon-navyDark transition shadow-lg shadow-riseon-navy/20"
              >
